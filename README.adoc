...
Es cuando no puedes realizar una actividad física o mental debido a un estrés, ansiedad u otra condición afixiante. Simplemente el cuerpo y la mente no colaboran y te imposibilitan totalmente funcionar con normalidad. Es común generarlo con el tiempo, principalmente cuando aparecen situaciones de considerable esfuerzo cuya recompensa es ínfima (Exprimir la fruta y al final te da poco o nada de jugo). Por ejemplo tenemos el uso del famoso https://en.wiktionary.org/wiki/crunch_time[crunch time], el cual es un periodo de alta presión para alcanzar un objetivo ("tenemos dos días para terminar este proyecto"). Si al final de esas 48 horas de locura, terminan rechazando el entregable, dando mayor plazo o simplemente no utilizarlo lo suficiente como para justificar su creación. La moral del equipo de desarrollo se desmorona y aumenta el nivel de _Burn Out_ a cada integrante.
