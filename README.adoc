...
En muchas empresas se hablan de distintos niveles de _seniority_ (_Junior_, _Engineer_, _Senior Engineer_, etc.). Sin embargo es un concepto muy ambigüo ya que varía entre cada empresa. Para poder estandarizar un poco, se debe detallar lo que se espera de un profesional en cada nivel.
...
trabajar junto a personas o condiciones que no te son gratas. Siempre puede haber mejores oportunidades y lugares de trabajo satisfactorios.
