...
Antes de firmar cualquier contrato léanlo apropiadamente, para evitar (cláusulas leoninas)[https://es.wikipedia.org/wiki/Cl%C3%A1usula_abusiva]. Por favor asesórense apropiadamente con personas con más experiencia antes de firmar cualquier cosa.

### Prestación de Servicios

En este contrato la empresa te solicita realizar un servicio. Este contrato es ideal para (Freelancers)[https://en.wikipedia.org/wiki/Freelancer] ya que es uno de los más flexibles y te permite trabajar remotamente, con quizás pocas reuniones presenciales.
...
- Debes tener iniciación de actividades en el (Servicio de Impuestos Internos)[www.sii.cl]. Para poder dar boletas de honorarios.
...
- La empresa paga tus cotizaciones.
