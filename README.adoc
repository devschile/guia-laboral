...
En el desarrollo de software existen multitud de herramientas, metodologías y tecnologías para aprender. Siempre es recomendable estudiar y mejorar los fundamentos. Se ha incluido la https://github.com/devschile/guia-laboral/blob/master/malla-ingenieria-software-2006.jpg[malla de la carrera _Ingeniería en Software_] de la https://www.uvm.cl[Universidad de Viña del Mar]. Como una guía de referencias sobre los temas para aprender, sus requisitos previos y un orden propuesto.

https://github.com/devschile/guia-laboral/blob/master/malla-ingenieria-software-2006.jpg[Ver Malla].
